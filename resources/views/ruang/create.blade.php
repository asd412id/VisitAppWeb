...
@endsection
@section('content')
<form action="{{ route('ruang.store') }}" enctype="multipart/form-data" method="post">
  @csrf
  <div class="row">
    <div class="col-sm-6">
      <div class="card">
        <div class="card-header">
          <h3>Data Ruang Baru</h3>
        </div>
        <div class="card-body">
          <div class="form-group">
            <label>Nama Ruang</label>
            <input type="text" name="nama" class="form-control" id="nama" value="{{ old('nama') }}" placeholder="Nama Ruang" required>
          </div>
          <div class="form-group">
            <label>Nama Kepala</label>
            <input type="text" name="kepala" class="form-control" id="kepala" value="{{ old('kepala') }}" placeholder="Nama Kepala" required>
          </div>
          <div class="form-group">
